...
<body>
	<div>Key: <input type="text" maxlength="8"><input type="button" value="build"></div>
	<canvas width="300" height="70"></canvas>
	<img width="300" height="70" src="" />
	<a download="captcha.gif" href="">download...</a>
</body>
	<script type="text/javascript">
		 ...
		 */
		function drawText(context, text, lineHeight, x, y, angle) {
		  if (!context) {
		    return;
		  }
		  ...
		  context.strokeText(text, 0, lineHeight / 2); // 绘制文本
		...
		void function() {
		  ...
		  function init(value) {
		    ...
		    for (var i = 0; i < canvas.height / lineHeight; i++) {
		      backTexts[i] = randomText('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789', backLength);
